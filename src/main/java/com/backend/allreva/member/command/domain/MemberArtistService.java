...
public class MemberArtistService {
    ...
    public boolean isNewMemberArtists(MemberArtistRequest req, List<MemberArtist> preMemberArtists) {
    ...
    public boolean isRemoveMemberArtist(MemberArtist pre, List<MemberArtistRequest> memberArtistRequests) {
